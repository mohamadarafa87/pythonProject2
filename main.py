...
model = pickle.load(open('/mohamadarafa87/pythonProject2/scrip.pkl','rb'))
modelLR = pickle.load(open('/mohamadarafa87/pythonProject2/scripL.pkl','rb'))
modelTR = pickle.load(open('/mohamadarafa87/pythonProject2/tree.pkl','rb'))
modelKN = pickle.load(open('/mohamadarafa87/pythonProject2/KNeighbor.pkl','rb'))
